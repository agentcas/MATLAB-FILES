...
hold on;
stem(t(1:100), x(1:100), 'k', 'MarkerFaceColor', 'm'); % Show original samples for comparison
...
subplot(4,1,4);
plot(t_downsampled(1:1000), x_downsampled(1:1000), 'r');
...
figure;
fvtool(h, 'Fs', L*Fs_in);  % Frequency response of the low-pass filter
