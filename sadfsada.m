% Given sample rates
Fs_in = 42000; % Input sample rate (44.1 kHz)
...
% Calculate the frequency at the 159th sample of the upsampled signal
t_159_upsampled = (159 - 1) / (L * Fs_in);
f_159_upsampled = 1 / t_159_upsampled;
f_159_upsampled_kHz = f_159_upsampled / 1000;
fprintf('The frequency at the 159th sample of the upsampled signal is %.2f kHz\n', f_159_upsampled_kHz);a