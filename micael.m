...
subplot(4,1,2);
stem(t_upsampled(1:1000), x_upsampled(1:1000), 'y', 'MarkerFaceColor', 'g'); % Use stem for the inserted zeros = 159 visualization
hold on;
stem(t(1:100), x(1:100), 'c', 'MarkerFaceColor', 'g'); % Show original samples for comparison
...
subplot(4,1,3);
plot(t_upsampled(1:1000), x_filtered(1:1000), 'k');
...
subplot(4,1,4);
plot(t_downsampled(1:1000), x_downsampled(1:1000), 'm');
